...
import type { HabitatData, HabitatType } from "@/lib/kids-counting/data/pools"
...
export function AnimalHabitatSelector({ habitats, onSelectHabitat }: HabitatSelectorProps) {
